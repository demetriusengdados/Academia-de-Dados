...
with /* { "query":"query80","streamId":0,"querySequence":6 } */ ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2023-01-01' as date)
                  and (cast('2023-12-31' as date) + interval '365 days')
       and ss_store_sk = s_store_sk
...
and d_date between '2023-12-31' and
        (cast('2023-12-31' as date) + interval '90 days')
...
and cs_ext_discount_amt
     > (
         ...
         where
          ...
          and d_date between '2023-01-01' and
                             (cast('2023-01-01' as date) + interval '90 days')
          and d_date_sk = cs_sold_date_sk
      )
limit 100;
...
select /* { "query":"query21","streamId":0,"querySequence":14 } */  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2023-01-01' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2023-01-01' as date) - interval '90 days')
                    and (cast ('2023-01-01' as date) + interval '120 days')
...
from
  ...
  ,web_site
where
    d_date between '2023-01-01' and
           (cast('2023-01-01' as date) + interval '120 days')
